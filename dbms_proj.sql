...
-- Add foreign key constraints to the product_color table
ALTER TABLE tbl_product_color
...
ALTER TABLE tbl_product_photo
ADD CONSTRAINT fk_product_productphoto
FOREIGN KEY (p_id) REFERENCES tbl_product(p_id);

ALTER TABLE tbl_product_size
ADD CONSTRAINT fk_product_color_tableproduct
FOREIGN KEY (p_id) REFERENCES tbl_product(p_id);

ALTER TABLE tbl_product_size
ADD CONSTRAINT fk_product_color_sizetable
